...
import 'package:complaints_app/core/localization/locale_cubit.dart';
  ...
  runApp(
    MultiBlocProvider(
      providers: [
        ...
        // ✅ (Localization) add LocaleCubit here
        BlocProvider<LocaleCubit>(
          create: (_) => LocaleCubit(
            initialLocale: LocaleCubit.loadSavedLocale(),
          ), // لاحقًا منضيف load/save إذا بدك
        ),
      ],
      child: const ComplaitsApp(),
    ),
    ...
    return BlocBuilder<ThemeCubit, ThemeState>(
      builder: (context, state) {
        return MaterialApp.router(
          ...
          // ✅ (Localization) add locale from LocaleCubit
          locale: context.watch<LocaleCubit>().state,

          // ✅ (Localization) add supported locales
          supportedLocales: LocaleCubit.supportedLocales,

          // ✅ (Localization) add delegates (generated by l10n)
